...
class LoginActivity : AppCompatActivity() {
    ...
    private fun areCredentialsGood(): Boolean {
        val emailMatch: Boolean = DataChecker.getInstance().checkData(
            binding.loginEmailInput.editText?.text.toString(),
    ...
    private fun login() {
        ...
        val params = JSONObject()
            ...
            .put(
                "password",
                DataChecker.getInstance().md5(binding.loginPasswordInput.editText?.text.toString())
            )
    ...
    private fun goToForm(formName: String) {
        val dest =
            if (formName == "register") RegisterActivity::class.java else ResetPasswordActivity::class.java
    ...
    private fun goDashboard() {
        ...
        val options: ActivityOptions = ActivityOptions.makeSceneTransitionAnimation(
            this,
            Pair<View, String>(binding.loginBanner, getString(R.string.transition_Logo))
        )
